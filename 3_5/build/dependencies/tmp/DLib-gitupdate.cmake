...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v1.1-free"
  WORKING_DIRECTORY "/Users/hyunggi/fastcampus_slam_codes/3_5/build/dependencies/src/DLib"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v1.1-free" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v1.1-free")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/hyunggi/fastcampus_slam_codes/3_5/build/dependencies/src/DLib'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/hyunggi/fastcampus_slam_codes/3_5/build/dependencies/src/DLib'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
