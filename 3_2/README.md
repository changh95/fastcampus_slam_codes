...
./build/superpointglue_sequence config/config.yaml weights/ /kitti/dataset/sequences/00/image_0/00 output
```
...
> Below is original repo by yuefanhao (https://github.com/yuefanhao/SuperPoint-SuperGlue-TensorRT)
